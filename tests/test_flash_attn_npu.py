...
test_cases = [
    ...
    (torch.bfloat16, 1, 1, 1, 1024, 1024, 128, 1, 128, False, -1, -1, 30.0),
    (torch.bfloat16, 5, 4, 4, 1024, 1024, 128, 0, 128, True, -1, -1, 30.0),
    (torch.float16, 7, 1, 1, 512, 512, 128, 1, 128, False, -1, -1, 50.0),
]
